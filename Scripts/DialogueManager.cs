...
{
    public Action<string, Sprite, string, IconPosition, bool> OnShowDialogueAndGetData;
    ...
    private void ShowCurrentLine()
    {
        ...
        OnShowDialogueAndGetData?.Invoke(currentCharacter.CharacterName, currentCharacter.CharacterSprite, line, currentCharacter.IconPosition, currentCharacter.IsShowIcon);
    }
